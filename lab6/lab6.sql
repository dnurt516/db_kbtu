...
WHERE d.dept_id IN (
SELECT dept_id FROM projects WHERE dept_id IS NOT NULL GROUP BY dept_id HAVING COUNT(project_id) > 1
);
...
UNION ALL
SELECT e.emp_id, e.emp_name, e.manager_id, o.path || ' > ' || e.emp_name, o.level + 1
FROM employees e JOIN org o ON e.manager_id = o.emp_id
)
SELECT * FROM org ORDER BY level, path;

SELECT a.emp_id AS emp1_id, a.emp_name AS emp1, b.emp_id AS emp2_id, b.emp_name AS emp2, a.dept_id
FROM employees a
